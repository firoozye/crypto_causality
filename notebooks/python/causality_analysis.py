...
resampled_returns_1h = combined_returns.copy()
resampled_returns_1h.index = pd.to_datetime(resampled_returns_1h.index)
resampled_returns_1h = resampled_returns_1h.resample('1H').last().dropna()
...
significant_asymmetric_results = asymmetric_pairwise_results[asymmetric_pairwise_results['significant']].copy()
